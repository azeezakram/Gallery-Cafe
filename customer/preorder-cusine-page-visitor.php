...
<body>
    ...
    <main>
        <div class="food-card-container">
            <h3>Pre-Order Cuisine</h3>
            <div class="search-container">
                <input class="search-bar" type="search" name="search" id="search-bar" placeholder="Search cuisine" autocomplete="off">
            </div>
    ...
    <footer class="footer">
        <div class="left-section">
            ...
            <div class="right-button" id="preorder-cushine-header">
                <a class="preorder-cushine-header" href="preorder-cusine-visitor.php">Pre-Order Cuisine</a>
            </div>
            <div class="right-button" id="about-us">
                <a class="about-us" href="about-page.html">About Us</a>
            </div>
